...
HD_PWD='E:/zyj/magic code/project_1/project_1.runs/clk_wiz_12MHz_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_wiz_12MHz.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_wiz_12MHz.tcl
